    ...
    <div className={cn("flex items-center gap-3", className)}>
      {socialLinks.map((link) => (
        <Link
          ...
          className="inline-flex size-10 items-center justify-center rounded-full text-text-secondary transition-colors hover:bg-bg-muted hover:text-text-primary"
        >
